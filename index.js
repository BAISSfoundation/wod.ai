...
class wod {
  constructor(home) {
    ...
    //  but this makes it cumbersome as you try to build multiple apps, because by default wod client will
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    this.home = home ? path.resolve(home) : path.resolve(os.homedir(), "wod")
    try {
...
//  }
  async query(req, cb) {
    ...
    if (!e) {
      cb(`File does not exist: ${Model}. Try "wod ${Core} get ${Model}" first.`)
      return
    }
